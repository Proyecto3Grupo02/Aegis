...
public:
	...
	btRigidBody* createRigidBody(RigidBody::RigidBodyType rbType, float _mass, Vector3 _dim, Vector3 _pos, Vector4 rotation, std::string bodyMeshName = "", bool isConvex = true, bool isKinematic = false, bool useGravity = true, float damp = 0.0f);
